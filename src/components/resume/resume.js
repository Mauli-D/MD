...
const Resume = props => {
  return (
    <section class="contentsection bg-light text-center" id="resume">
      <div class="contentsection-heading">
        <h1 class="text-uppercase mb-3">Work Experience</h1>
      </div>
      <div class="container">
        <div class="row">
          <ul class="col-lg-7 mx-auto text-white text-justify">
            <li class="bg-dark mb-4 p-3">
              <div>
                <div class="row pt-3">
                  <div class="col-6 mb-2 mx-auto">
                    <h4>Software developer</h4>
                  </div>
                  <div class="col-6 mb-2 mx-auto text-right">
                    <div class="date">
                      <i class="icon-calendar"></i> September 2016 - August 2017
                    </div>
                  </div>
                </div>
                <hr class="hr-main" />
                <h4><i class="icon-briefcase"></i> Kalp Corporate</h4>
                <div>
                  <p> <i class="icon-pin"></i>
            ...
            <li class="bg-dark mb-4 p-3">
              <div>
                <div class="row pt-3">
                  ...
                  <div class="col-6 mb-2 mx-auto text-right">
                    <div class="date">
                      <i class="icon-calendar"></i> July 2016 - September 2016
                    </div>
                  </div>
                </div>
                <hr class="hr-main" />
                <h4><i class="icon-briefcase"></i> Atharva System</h4>
                <div>
                  <p> <i class="icon-pin"></i>
      ...
      <div>
        <a class="btn btn-primary btn-xl" href="MaulikaDesai.pdf" target="_blank" download>Download Resume!</a>     
      </div>
    </section>
  );
};
