...
const Header = props => {
  return (
    <header class="contentsection masthead d-flex text-white text-center" id="page-top">
      <div id="wrapper">
        <div id="title">
          <div class="container text-white my-auto text">
            <div class="mb-1">Hello, I'm <span class="text-secondary">Maulika Desai</span></div>
            <div class="mb-5 font-weight-normal">
              <em>Computer Programmer | Full Stack Developer | Web Developer</em>
            </div>
            <div class="canvasdiv">
            <canvas id="canvas" width="1950px" height="600px"></canvas>
            <canvas id="canvasbg" width="1950px" height="600px"></canvas>
            </div>
          </div>
        </div> 
      </div>
  ...
  return (
    <footer class="Footer text-center text-white bg-dark">
      <div class="text-center lead">
        <p class="text-muted small mb-0">Maulika Desai &copy;2019</p>
      </div>
    </footer>
  );
};
